<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Items.aspx.cs" Inherits="SlackMUDRPG.Items" %>
			...
			<div class="row full-height">
				<div class="col-xs-12 full-height">
					<div class="content-block">
						<p style="color: #fff; padding-left: 30px;">Coming Soon ...</p>
					</div>
				</div>
			</div>
		</div>
