...
namespace SlackMUDRPG.Utility.Formatters
{
	public abstract class ResponseFormatter
	{
		...
		/// <param name="text"></param>
		/// <returns>Tagged text string.</returns>
		public abstract string Color(string text, string color, int newlines = 1);
		...
		/// <param name="text"></param>
		/// <returns>Tagged text string.</returns>
		public abstract string Size(string text, int size, int newlines = 1);
		...
		/// <param name="text"></param>
		/// <returns>Tagged text string.</returns>
		public abstract string Strike(string text, int newlines = 1);
		...
		/// <param name="text"></param>
		/// <returns>Tagged text string.</returns>
		public abstract string Underline(string text, int newlines = 1);
